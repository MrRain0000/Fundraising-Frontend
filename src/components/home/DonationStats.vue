...
const donors = [
  {
    ...
    initial: "Đ",
    color: "purple",
    projectName: "Xây trường bán trú Nam Cần",
  },
  {
    id: 2,
    name: "Huỳnh Thị Mai",
                ...
                <div class="donors-scroll-content">
                  ...
                  >
                    ...
                    <div class="donor-info">
                      ...
                      <p class="donor-project">{{ donor.projectName }}</p>
